...
def draw_boxes(image, boxes, scores,classO):
    ...
    for i, box in enumerate(boxes):
        ...
        draw.text((x2+3, y1), f"{score:.2f}_{classO[i]}", fill=color,stroke_width=1,font=font,spacing=20)  # Add score as text above the box
...
path_input = "/home/athip/psu/3/ecosys/proj/dev/model/data/2024-10-05_13:05:33/input"
path_output = "/home/athip/psu/3/ecosys/proj/dev/model/data/2024-10-05_13:05:33/output"
prediction(path_input,path_output)
